...
describe('TreeController', function(){
  ...
  it('Should getRelatives', function(){
    ...
    expect($scope.relatives[23].residence).to.equal('Hawaii');
    expect($scope.relatives[24].similarity).to.equal(0.002);
  });
